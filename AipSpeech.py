...
class BaiduRest:
 ...
 #       subprocess.call(['sox', filename, '-e', 'mu-law',
 #                        '-r', '16k', 'wavfilename', 'remix', '1,2'])
        subprocess.call(['ffmpeg', '-i', filename,wavfilename],shell=True)
...
if __name__ == "__main__":
    ...
    api_key = "sqt1yqevnbOge4ViLUxTSWf4"
    api_secert = "GYxHcnAy7GXIXbi8BVgjNkO9OPU96XfN"
    # 初始化
    ...
    bdr.getVoice("利用python，调用百度语音api，有、实现语音合成与识别，作者：LiaoCJ","aipspeech.mp3")
    # 识别test.wav语音内容并显示
    print(bdr.getText(bdr.ConvertToWav("aipspeech.mp3","aipspeech.wav")))